...
VELO_DIR = Path("/home/sasaki/datasets/kitti_seq00_velodyne")
POSES = Path("/home/sasaki/datasets/kitti_seq00_subset/poses_00.txt")
TIMES = Path("/home/sasaki/datasets/kitti_seq00_full/times.txt")
