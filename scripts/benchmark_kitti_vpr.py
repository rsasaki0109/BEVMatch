...
SEQUENCES = [
    ("00",
     Path("/home/sasaki/datasets/kitti_seq00_full/image_0"),
     Path("/home/sasaki/datasets/kitti_seq00_subset/poses_00.txt"),
     Path("/home/sasaki/datasets/kitti_seq00_full/times.txt")),
]
